...
const rooms = [
  {
    name: "Kitchen",
    before: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=900&q=80",
    after: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=900&q=80",
  },
  {
    name: "Bathroom",
    before: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&q=80",
    after: "https://images.unsplash.com/photo-1582562128784-a96ef13c0858?w=900&q=80",
  },
  {
    name: "Living Room",
    before: "https://images.unsplash.com/photo-1595515106969-1ce29566b00c?w=900&q=80",
    after: "https://images.unsplash.com/photo-1615874959474-d4d52e1dd1e2?w=900&q=80",
  },
];
...
function Slider({ room }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('${room.after}')` }}>
        <div className="absolute top-3 right-3 bg-deep-green/90 text-white text-xs font-medium px-3 py-1 rounded-full">After</div>
      </div>
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('${room.before}')`, clipPath: `inset(0 ${100 - sliderPos}% 0 0)` }}>
    ...
    <section className="w-full py-20 md:py-28 bg-white flex justify-center">
      <div className="w-full max-w-[900px] px-6">
        ...
        <div className={`transition-opacity duration-300 ${fade ? "opacity-100" : "opacity-0"}`}>
          <Slider key={active} room={rooms[active]} />
        </div>

      ...
      <div className="w-full max-w-5xl px-6">
        ...
        >
          <div className="absolute inset-0 bg-cover bg-center"
            ...
            <div className="absolute top-3 left-3 bg-white/90 text-charcoal text-xs font-medium px-3 py-1 rounded-full">After</div>
          </div>
          <div className="absolute inset-0 bg-cover bg-center"
            style={{
            ...
            <div className="absolute top-3 left-3 bg-white/90 text-charcoal text-xs font-medium px-3 py-1 rounded-full">Before</div>
          </div>
